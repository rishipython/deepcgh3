...
save_path = '/nrs/turaga/athavaler/experiments/exp028_train_slm_deocder_on_random_smaller_encoder'
...
def create_train_state(module, rng, learning_rate):
    ...
    params_encoder = variables['params']['encoder']
