...
save_path = '/nrs/turaga/athavaler/experiments/exp019_017restartedwithlowerlr'

if not os.path.exists(save_path):
    os.makedirs(save_path)

starting_params_path = '/nrs/turaga/athavaler/experiments/exp017_pretrain_encoder_amp_phase_output/params_epoch_15000.pkl'
starting_opt_state_path = '/nrs/turaga/athavaler/experiments/exp017_pretrain_encoder_amp_phase_output/state_opt_state_epoch_15000.pkl'
