...
starting_params_path = f"/nrs/turaga/athavaler/experiments/{os.getcwd().split('/')[-2]}/{os.getcwd().split('/')[-1]}/params_epoch_89000.pkl"

starting_opt_state_path = f"/nrs/turaga/athavaler/experiments/{os.getcwd().split('/')[-2]}/{os.getcwd().split('/')[-1]}/state_opt_state_epoch_89000.pkl"

starting_batch_stats_path = f"/nrs/turaga/athavaler/experiments/{os.getcwd().split('/')[-2]}/{os.getcwd().split('/')[-1]}/batch_stats_epoch_89000.pkl"
