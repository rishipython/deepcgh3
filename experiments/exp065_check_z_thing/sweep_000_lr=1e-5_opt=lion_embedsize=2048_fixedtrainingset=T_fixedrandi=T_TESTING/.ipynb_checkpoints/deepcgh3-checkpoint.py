...
starting_params_path = 'params_current.pkl'

starting_opt_state_path = 'state_opt_state_current.pkl'

starting_batch_stats_path = 'batch_stats_current.pkl'
...
for i in range(100):
    ...
    for j in range(batch_size):
        test_data.append([batch_ele[j][None,...] for batch_ele in batch])
...
for i, batch in enumerate(test_data):
  t0 = time.time()
  (recon, slm_phase), (amp, phase, field) = run_model(state=state, batch=batch)
