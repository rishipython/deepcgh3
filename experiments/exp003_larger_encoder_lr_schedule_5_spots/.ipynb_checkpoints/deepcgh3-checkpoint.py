...
save_path = '/nrs/turaga/athavaler/experiments/exp003_larger_encoder_lr_schedule_5_spots'
...
class DeepCGHEncoder(nn.Module):
  ...
  def __call__(self, x):
    ...
    for i in range(6):
       ...
       embedding = embedding + nn.leaky_relu(nn.Dense(features=1024)(embedding))
       embedding = nn.LayerNorm()(embedding)
