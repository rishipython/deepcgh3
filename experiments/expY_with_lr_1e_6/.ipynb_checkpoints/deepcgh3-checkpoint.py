...
save_path = '/nrs/turaga/athavaler/experiments/expY_with_lr_1e_6'

if not os.path.exists(save_path):
    os.makedirs(save_path)

starting_params_path = '/nrs/turaga/athavaler/experiments/expY/params_epoch_5000.pkl'
starting_opt_state_path = '/nrs/turaga/athavaler/experiments/expY/state_opt_state_epoch_5000.pkl'
