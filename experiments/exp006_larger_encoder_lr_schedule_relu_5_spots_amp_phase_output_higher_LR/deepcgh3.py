...
save_path = '/nrs/turaga/athavaler/experiments/exp006_larger_encoder_lr_schedule_relu_5_spots_amp_phase_output_higher_LR'
...
def create_train_state(module, rng, learning_rate):
    ...
    tx = optax.chain(optax.adam(learning_rate),
                     optax.contrib.reduce_on_plateau(patience=10000, cooldown=0, factor=0.9, accumulation_size=5000))
