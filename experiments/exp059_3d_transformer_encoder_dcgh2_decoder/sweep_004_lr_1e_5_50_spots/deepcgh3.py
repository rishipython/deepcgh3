...
train_data = deserialize('/nrs/turaga/athavaler/experiments/exp057_generate_data', 'train_data_001.pkl')
test_batch = gen.get_batch(batch_size)
serialize('', f'test_batch.pkl', test_batch)
serialize(save_path, f'test_batch.pkl', test_batch)

for step in range(num_steps_per_epoch*epochs):
  # batch = gen.get_batch(batch_size)
  batch = train_data[int(step % len(train_data))]
