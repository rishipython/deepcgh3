...
save_path = '/nrs/turaga/athavaler/experiments/exp044_fixed2'

if not os.path.exists(save_path):
    os.makedirs(save_path)

starting_params_path = '/nrs/turaga/athavaler/experiments/exp044_fixed/params_epoch_2000.pkl'
starting_opt_state_path = '/nrs/turaga/athavaler/experiments/exp044_fixed/state_opt_state_epoch_2000.pkl'
