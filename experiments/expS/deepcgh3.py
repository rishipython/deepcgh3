...
save_path = '/nrs/turaga/athavaler/experiments/expS'
...
class DeepCGH(nn.Module):
    ...
    def spot_coordinates_to_phase(self, spot_coordinates: Array) -> Array:
        ...
        inr_linear_layers = [nn.Dense(f) for f in [512, 512, 512, 512, 1]]
        inr_frequency_shifts = [nn.sigmoid(nn.Dense(2)(spot_embedding)) * 2.0 * jnp.pi for f in range(len(inr_linear_layers))]
