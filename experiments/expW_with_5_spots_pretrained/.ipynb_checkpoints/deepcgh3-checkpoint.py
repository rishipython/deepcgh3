...
save_path = '/nrs/turaga/athavaler/experiments/expW_with_5_spots_pretrained'

if not os.path.exists(save_path):
    os.makedirs(save_path)

starting_params_path = '/nrs/turaga/athavaler/experiments/expW/params_epoch_5000.pkl'
starting_opt_state_path = '/nrs/turaga/athavaler/experiments/expW/state_opt_state_epoch_5000.pkl'
